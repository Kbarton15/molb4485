...
raxmlHPC-PTHREADS-AVX -T 8 -f a -m GTRGAMMA -p 618 -N 2 -x 309 -s KnownBears.aln \
-n KnownBearsTree -w /project/inbre-train/inbre005/mob4485/Barton_Phylo/BearTrees -o GiantPanda
